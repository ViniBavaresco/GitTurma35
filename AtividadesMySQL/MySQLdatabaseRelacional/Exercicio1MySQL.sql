...
select*from tb_infoFuncionarios where salario > 2000; -- Mostrar tabela de funcionários com salário maior que R$2000,00
select*from tb_infoFuncionarios where salario < 2000; -- Mostrar tabela de funcionários com salário menor que R$2000,00
